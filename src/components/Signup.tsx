...
export default function Signup() {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await activityLogService.createLog('User Signup')
      setSuccess(true)
              ...
              <div className="ml-3">
                ...
                <div className="mt-4">
                  <button
                    ...
                    className="text-sm font-medium text-green-800 dark:text-green-200 hover:text-green-700 dark:hover:text-green-100 bg-transparent border-none p-0 cursor-pointer"
                  >
                    Go to login →
                  </button>
                </div>
