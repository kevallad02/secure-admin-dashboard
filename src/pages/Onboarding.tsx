    ...
    <DashboardLayout>
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        {step === 1 ? (
          ...
          className="app-shell shadow rounded-lg border border-gray-200 dark:border-gray-700 p-6 space-y-6"
          >
          <div>
          ...
          <div>
            <h2 className="text-lg font-medium text-gray-900 dark:text-white">First product</h2>
          ...
          >
            <div>
              <h2 className="text-lg font-medium text-gray-900 dark:text-white">Warehouse setup</h2>
              <div className="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2">
                <div>
                  <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">
                    Location name
